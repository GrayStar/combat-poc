...
export const summonOssentinel = {
	spellTypeId: SPELL_TYPE_ID.SUMMON_OSSENTINEL,
	title: 'Summon Ossentinel',
	description: 'Summon an Ossentinel to divert enemy attention, loyal to the target',
	cost: [
		{
